...
| **AWS Artifact** | Self-service download of SOC 2, ISO 27001, PCI-DSS AOC, FedRAMP packages, and the AWS Data Processing Addendum (DPA) — the documents you hand an auditor; also where you accept agreements like the **HIPAA BAA** (there is **no "HIPAA AOC"** — the HIPAA artifact is the signed BAA plus supporting reports such as SOC 2, per [AWS HIPAA compliance](https://aws.amazon.com/compliance/hipaa-compliance/)). | [AWS Artifact](https://aws.amazon.com/artifact/) |
