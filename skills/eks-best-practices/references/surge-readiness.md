...
- **Cluster services pre-scaled** — CoreDNS scaled ahead of the pod step so DNS resolution is not the bottleneck (see [autoscaling.md — CoreDNS Autoscaling](autoscaling.md#coredns-autoscaling)).
