...
| **Envelope-encryption CMK** | Your customer-managed KMS key (default AWS-owned key applies on 1.28+ if you don't) | Can be associated later, but **[irreversible once set](https://docs.aws.amazon.com/eks/latest/userguide/enable-kms.html)** — and a disabled/deleted CMK degrades or bricks the cluster |
