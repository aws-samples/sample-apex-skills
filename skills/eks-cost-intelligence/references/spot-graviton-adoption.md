...
Spot and Graviton adoption is the second-highest weighted dimension (20 points max deduction). It evaluates whether the cluster takes advantage of Graviton processors (up to 40% better price-performance) and Spot instances (up to 90% discount) where workloads are eligible.
