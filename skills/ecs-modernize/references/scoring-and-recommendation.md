...
- Application-server coupling — vendor-specific deployment descriptors versus standard containers (`tech_stack.app_servers`)
...
| 30–59 | OS-specific API or process-model findings present, but all carry remediation class `replatform_ok` (they function inside a container of the matching OS) |
...
- ASP.NET support policy (Web Forms / MVC on .NET Framework): https://learn.microsoft.com/en-us/lifecycle/products/aspnet
