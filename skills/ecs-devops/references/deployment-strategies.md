...
| Circuit breaker / alarms (rolling) | ✅ | ✅ | ✅ | ⚠️ circuit breaker not explicitly documented for the EXTERNAL launch type — verify ([details](failure-detection-and-rollback.md)); alarms per metric availability |
