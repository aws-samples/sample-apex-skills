...
:::info[Source]
This page is generated from [steering/workflows/design.md](https://github.com/aws-samples/sample-apex-skills/blob/main/steering/workflows/design.md). Edit the source, not this page.
:::
