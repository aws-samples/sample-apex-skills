...
:::info[Source]
This page is generated from [steering/workflows/new-skill.md](https://github.com/aws-samples/sample-apex-skills/blob/main/steering/workflows/new-skill.md). Edit the source, not this page.
:::
