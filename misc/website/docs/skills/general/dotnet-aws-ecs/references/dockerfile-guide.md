...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/dotnet-aws-ecs/references/dockerfile-guide.md
format: md
---

:::info[Source]
This page is generated from [skills/dotnet-aws-ecs/references/dockerfile-guide.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/dotnet-aws-ecs/references/dockerfile-guide.md). Edit the source, not this page.
:::
