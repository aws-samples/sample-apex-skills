---
title: "CDK Template Guide (C#)"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/dotnet-aws-ecs/references/cdk-template-guide.md
format: md
---

:::info[Source]
This page is generated from [skills/dotnet-aws-ecs/references/cdk-template-guide.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/dotnet-aws-ecs/references/cdk-template-guide.md). Edit the source, not this page.
:::
