---
title: "Multi-Arch Container Build Pipelines"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/graviton-migration/references/multi-arch-pipelines.md
format: md
---

:::info[Source]
This page is generated from [skills/graviton-migration/references/multi-arch-pipelines.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/graviton-migration/references/multi-arch-pipelines.md). Edit the source, not this page.
:::
...
This is why the [cutover runbook](karpenter-migration) tells you never to bake an `-arm64` suffix into a Kubernetes manifest: the manifest list already does arch selection. Your CI job's deliverable is therefore "push a manifest list covering `linux/amd64,linux/arm64`", not "build an arm64 image."
