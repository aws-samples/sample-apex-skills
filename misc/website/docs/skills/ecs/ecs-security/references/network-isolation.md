---
title: "Layer 5 — Network Isolation"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-security/references/network-isolation.md
format: md
---

:::info[Source]
This page is generated from [skills/ecs-security/references/network-isolation.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-security/references/network-isolation.md). Edit the source, not this page.
:::

# Layer 5 — Network Isolation

What a task is *allowed to reach* and be reached by. The foundation is the **`awsvpc` network mode**, which gives each task its own elastic network interface (ENI) with its own private IP and security groups — enabling per-task/per-service network isolation that bridge/host mode cannot. Reference: [Network security best practices for Amazon ECS](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/security.html) · [ECS Best Practices: Security (network)](https://docs.aws.amazon.com/AmazonECS/latest/bestpracticesguide/security.html).
...
| `com.amazonaws.region.ssm` | Interface | SSM Parameter Store secrets / ECS Exec |
...
## Sources
- [Network security best practices for Amazon ECS](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/security.html) · [ECS Best Practices: Security](https://docs.aws.amazon.com/AmazonECS/latest/bestpracticesguide/security.html)
