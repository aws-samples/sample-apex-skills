...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-build/references/autoscaling.md
format: md
---

:::info[Source]
This page is generated from [skills/ecs-build/references/autoscaling.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-build/references/autoscaling.md). Edit the source, not this page.
:::
...
Application Auto Scaling for ECS services. Cluster-level capacity scaling (managed scaling on ASG providers, MI decision logic) lives in [capacity-provider-guide.md](capacity-provider-guide) -- this file is task-count scaling.
