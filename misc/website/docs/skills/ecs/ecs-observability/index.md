...
|---|---|
| [log-delivery.md](references/log-delivery) | blocking vs non-blocking details, buffer-size benchmarks, awslogs options, FireLens/Fluent Bit configuration, filesystem buffering, high-throughput logging |
