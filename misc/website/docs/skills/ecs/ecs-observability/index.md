...
> Facts verified 2026-07-09 against https://docs.aws.amazon.com/xray/latest/devguide/xray-sdk-daemon-timeline.html
...
Before asserting any capability, check [references/launch-type-matrix.md](references/launch-type-matrix) — the per-capability EC2/Fargate/MI/EXTERNAL matrix with a source URL per row. The recurring traps:
