---
title: "ECS Observability — Launch-Type Support Matrix"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-observability/references/launch-type-matrix.md
format: md
---

:::info[Source]
This page is generated from [skills/ecs-observability/references/launch-type-matrix.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/ecs-observability/references/launch-type-matrix.md). Edit the source, not this page.
:::
...
**For per-capability depth, see:** [log-delivery.md](log-delivery), [metrics-stacks.md](metrics-stacks), [tracing-and-signals.md](tracing-and-signals), [native-visibility-and-exec.md](native-visibility-and-exec)
...
| X-Ray daemon sidecar (legacy — maintenance mode since 2026-02-25) | Yes | Yes (sidecar only) | Undocumented — verify | Undocumented — verify (daemon additionally needs outbound reach to X-Ray endpoints from on-prem) | https://docs.aws.amazon.com/xray/latest/devguide/xray-daemon-ecs.html |
