...
:::info[Source]
This page is generated from [skills/steering-workflow-creator/assets/workflow-skeleton.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/steering-workflow-creator/assets/workflow-skeleton.md). Edit the source, not this page.
:::
