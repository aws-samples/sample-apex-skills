...
:::info[Source]
This page is generated from [skills/eks-mcp-server/SKILL.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-mcp-server/SKILL.md). Edit the source, not this page.
:::
