...
Also run [references/drift-detection.md](references/drift-detection) (10 baseline checks) and
[references/cost-analysis.md](references/cost-analysis) (savings opportunities). These inform the
