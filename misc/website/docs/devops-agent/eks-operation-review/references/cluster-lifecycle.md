...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-operation-review/references/cluster-lifecycle.md
format: md
---

:::info[Source]
This page is generated from [devops-agent/eks-operation-review/references/cluster-lifecycle.md](https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-operation-review/references/cluster-lifecycle.md). Edit the source, not this page.
:::
