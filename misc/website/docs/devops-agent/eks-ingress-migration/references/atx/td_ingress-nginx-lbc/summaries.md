...
title: "Summaries"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/references/atx/td_ingress-nginx-lbc/summaries.md
format: md
---

:::info[Source]
This page is generated from [devops-agent/eks-ingress-migration/references/atx/td_ingress-nginx-lbc/summaries.md](https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/references/atx/td_ingress-nginx-lbc/summaries.md). Edit the source, not this page.
:::
