...
Generate a single markdown report file in the working directory.
...
Total = 34  ->  score = 100 - 34 = 66  (HARD)

Re-architecture Gate = 1  ->  "1 route needs redesign (snippet on /checkout)"
```

Final: **66 / HARD — 1 route needs redesign.** The model credits the 6 done + 2 easy routes, drops CORS/allowlist/rate-limit to Impact 2, counts 10 (not 18) for volume, and reports the one true blocker as a gate instead of erasing the number.
...
*This report was generated by a Kiro skill provided as sample code for educational
