...
> **DevOps Agent port note:** This document describes the recommended migration plan structure for the assessment report. These are PLANNED steps to document — never execute mutating commands. The agent's role is assessment and planning only.
