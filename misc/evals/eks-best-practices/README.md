...
- **`eks-upgrade-check`** (upgrade readiness scoring) — "is my cluster ready for 1.32?" asks for a readiness *score*, not design advice.
- **`eks-operation-review`** (operational excellence audit) — "audit my cluster operations" is a live-cluster review, not an architecture decision.
<!-- SIBLING_MAP_END -->
